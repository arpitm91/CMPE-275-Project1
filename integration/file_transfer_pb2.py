...
_FILEINFO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='fileid', full_name='grpc.FileInfo.fileid', index=0,
...
_CHUNKLOCATIONINFO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='chunkId', full_name='grpc.ChunkLocationInfo.chunkId', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ip', full_name='grpc.ChunkLocationInfo.ip', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='port', full_name='grpc.ChunkLocationInfo.port', index=2,
...
_FILELOCATIONINFO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='lstChunkLocation', full_name='grpc.FileLocationInfo.lstChunkLocation', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='isFileFound', full_name='grpc.FileLocationInfo.isFileFound', index=2,
...
_FILELOCATIONINFO.fields_by_name['lstChunkLocation'].message_type = _CHUNKLOCATIONINFO
