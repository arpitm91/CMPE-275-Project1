...
var fileDescriptor_b042552c306ae59b = []byte{
	...
	0x43, 0x87, 0x34, 0x50, 0x0a, 0x18, 0x08, 0x8a, 0x16, 0x82, 0x7f, 0x12, 0x03, 0x82, 0x63, 0x50,
	0x76, 0xd1, 0x9e, 0x8c, 0x35, 0x77, 0xa5, 0x2c, 0x42, 0x71, 0x69, 0x6a, 0x65, 0x44, 0x87, 0x1e,
	0x7b, 0xe8, 0xb9, 0x7d, 0x89, 0xbe, 0x48, 0x9f, 0xa2, 0x0f, 0x53, 0xec, 0x90, 0x94, 0x48, 0xc9,
	...
	0xba, 0x13, 0x39, 0x89, 0x43, 0xae, 0xf8, 0xb9, 0x08, 0xf9, 0x7f, 0x32, 0xf0, 0x03, 0xb4, 0x83,
	...
	0xa9, 0xba, 0x74, 0xf7, 0x8a, 0xb6, 0xdf, 0x43, 0x47, 0xd7, 0x50, 0xde, 0x6e, 0x46, 0x9e, 0xa7,
	0x16, 0x8f, 0x2f, 0x7d, 0xd1, 0xff, 0x0d, 0xec, 0xbc, 0xe1, 0x6a, 0x7d, 0x79, 0xf6, 0x52, 0x93,
	0xd5, 0x05, 0x5d, 0xf0, 0xb1, 0xe6, 0x70, 0x06, 0x24, 0x0f, 0x54, 0xb8, 0x00, 0xff, 0x37, 0x4c,
	0xef, 0x35, 0x34, 0x10, 0x6b, 0xde, 0xc8, 0x2e, 0xb4, 0x50, 0x5e, 0xeb, 0x24, 0x1e, 0xf5, 0xfd,
	0xa2, 0xd0, 0xfb, 0x05, 0xb6, 0x97, 0xa4, 0xe6, 0x01, 0xbe, 0x81, 0xce, 0x52, 0xf9, 0x84, 0x28,
	0xe4, 0x18, 0x3a, 0xa5, 0xcf, 0x84, 0x50, 0x42, 0x4f, 0xf1, 0x6e, 0x8e, 0xa4, 0xf4, 0x05, 0x29,
	0x50, 0x79, 0xb7, 0x85, 0xff, 0x9d, 0x5e, 0xfd, 0x13, 0x00, 0x00, 0xff, 0xff, 0x69, 0x63, 0xcf,
	0x35, 0x49, 0x09, 0x00, 0x00,
}
...
type RaftServiceClient interface {
	...
	FileUploadCompleted(ctx context.Context, in *UploadCompleteFileInfo, opts ...grpc.CallOption) (*Ack, error)
...
func (c *raftServiceClient) FileUploadCompleted(ctx context.Context, in *UploadCompleteFileInfo, opts ...grpc.CallOption) (*Ack, error) {
	out := new(Ack)
...
type RaftServiceServer interface {
	...
	// (Data center -> Raft) : Signals upload completed to raft
	FileUploadCompleted(context.Context, *UploadCompleteFileInfo) (*Ack, error)
	// (Proxy -> Raft) : Fetches location of an existing file from raft
